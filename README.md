...
> Hyper convert between base2/8/10/16/36/62

[![PyPI version](https://badge.fury.io/py/hyper-base-convert.svg)](https://pypi.org/project/hyper-base-convert/)
...
```bash
pip install hyper-base-convert
```

## Quick Start

```python
from hyper_base_convert import convert
...
from hyper_base_convert import batch
